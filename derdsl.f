     ...
     &      ,INDSSTR  ,INEW     ,INTI     ,IOCAP    ,IODENS   ,IOFMLT
     &      ,IOTRLI   ,LMXNDL   ,NFLAGS   ,NFNL     ,NINT     ,NPAR
     &      ,NPAREL   ,NTYPAR   ,NUMEL    ,NUMNP    ,NZPAR    ,BIBI
     &      ,CAUX1    ,CCAL     ,CCALAN   ,CFPAREL  ,DENSITY  ,DERC
...
C------------------------- Internal
      ...
      INTEGER*4::I1   ,I2   ,IC   ,IP   ,J    ,JJ   ,K1   ,K2   ,KNT  ,L
...
C------------------------- First executable statement
     ...
     &    ,PARACD   ,PARC(INORPAR(19)+1),CCAL     ,CCALAN   ,XPARAM
                  ...
                  DO K1=1,NNUD-1
                      ...
                      DO K2=K1+1,NNUD
                          ...
                          DO J=1,LANI
                              ...
                              S = S + QXYZ(J,L)*BIBI(KNT+J,L)*DENSL
