      SUBROUTINE ASSEMBLE_SYM_INTO_BAND_NO_SYM
     &          (A, A_DSC, FACTOR, IA_COLS, IA_ROWS, IDSC_COLS,IDSC_ROWS
     &          ,KXX,LNNDEL,LMXNDL,NBAND)
********************************************************************************
*
* PURPOSE  To assemble a symmetric matrix into a  non-symetric banded matrix.
*
*
* DESCRIPTION The subroutine assembles the elements (multiplied by a factor)
*             of a symmetric matrix into non-symmetric banded one.
*
*             The symmetric matrix must be stored in a vector
...
********************************************************************************
          ...
          INTEGER*4::NNUD,I,J,IJCOL,JICOL,IPOS_AIJ,IPOS_DIAG,L,LMXNDL
     &              ,NODE1,NODE2,NBAND,IDIAG
...
C------------------------- Diagonal.
                  IPOS_DIAG = (I - 1)*NNUD + I - I*(I-1)/2

                  A_DSC(NODE1,IDIAG) = A_DSC(NODE1,IDIAG)
     &                               + A(L,IPOS_DIAG) * FACTOR
...
C------------------------- Last Diagonal term.
          IPOS_DIAG = (NNUD - 1)*NNUD + NNUD - NNUD*(NNUD-1)/2
	...
	END SUBROUTINE ASSEMBLE_SYM_INTO_BAND_NO_SYM